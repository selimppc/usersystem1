...
<div class="row">
    <div class="col-sm-12">
        <div class="panel">
            ...
            {!! Form::open(['route' => 'store-flat', 'id' => 'form_2']) !!}
                ...
                <div class="form-group form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            {!! Form::Select('materiaal',array('pvc_celtec'=>'PVC(CELTEC)','zwart_staal'=>'ZWART_STAAL','galvaan'=>'GALVAAN','aluconbond'=>'ALUCONBOND','alluminium'=>'ALLUMINIUM'),@Input::get('materiaal')? Input::get('materiaal') : null,['class'=>'form-control ','required','title'=>'select materiaal']) !!}
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            {!! Form::label('dikte', 'DIKTE', ['class' => 'control-label']) !!}
                            {!! Form::Select('dikte',array('2'=>'2mm','3'=>'3mm','4'=>'4mm','6'=>'6mm','10'=>'10mm','12'=>'12mm'),@Input::get('dikte')? Input::get('dikte') : null,['class'=>'form-control ','required','title'=>'select DIKTE']) !!}
                        </div>
                    </div>
                </div>
                {{-------------Installation-----------------------------------------------------------------------------}}
    ...
    <div class="row">
        ...
        @if(isset($data['installment_amount']))
            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="panel-heading">
                        <span class="panel-title"><h5 class="text-center">TOTAL</h5></span>
                    </div>
                    <div class="panel-body">
                        <div class="table-primary">
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
